    ...
    <center>
      <div class="container" style="background-color: #343F66; color: white; padding: 16px;">
        <div class="row">
          ...
          <div class="col-sm-8" style="text-align:right;">
            <button type="button" class="btn btn-success" id="add_train">Add Training Record</button>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <table id="example" class="table  table-bordered nowrap" style="width:100%">
          ...
          <tbody >
            <?php include 'Records/training.php'; ?>
          </tbody>
        </table>

      </div>

        <?php include 'Records/add_training.php'; ?>
      <div class="modal fade" id="training" role="dialog" style="text-align:left;">
        <form method="post">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="alert alert-success" role="alert">
                Are you sure you want to add this training record?
              </div>
              <div class="form-group">
                <label for="exampleFormControlSelect1">Teacher</label>
                <select class="form-control" name="teach" id="teach">
                  <option value="" readonly selected>Select Teacher</option>
                  <?php include 'Eval_Sched/select_tc.php'; ?>
                </select>
              </div>

              <div class="form-group">
                <label for="exampleFormControlInput1">Certificate</label>
                <input type="text" class="form-control" name="certi" id="certi" >
              </div>
              <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <button name="addtrain" class="btn btn-success">Add Training Record</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div class="modal fade" id="delt" role="dialog" style="text-align:left;">
        <form method="post">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #343F66; color: white;">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="exampleFormControlSelect1">Teacher</label>
                <select class="form-control" name="dteach" id="dteach" readonly>
              ...
              <div class="form-group">
                <label for="exampleFormControlInput1">Certificate</label>
                <input type="text" class="form-control" name="dcerti" id="dcerti" readonly>
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">Location</label>
                <input type="text" class="form-control" name="dloc" id="dloc" readonly>
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">Date</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
              <button name="deltrain" class="btn btn-success" >Delete Training Record</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div class="modal fade" id="edittrain" role="dialog" style="text-align:left;">
        <form method="post">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background-color: #343F66; color: white;">
            ...
            <div class="modal-body">
              <div class="alert alert-info" role="alert">
                Are you sure you want to edit this training record?
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">ID</label>
              ...
              <div class="form-group">
                <label for="exampleFormControlSelect1">Teacher</label>
                <select class="form-control" name="eteach" id="eteach">
                  <option value=""  selected>Select Teacher</option>
                  <?php include 'Eval_Sched/select_tc.php'; ?>
                </select>
              </div>
              ...
              <div class="form-group">
                <label for="exampleFormControlInput1">Certificate</label>
                <input type="text" class="form-control" name="ecerti" id="ecerti" >
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">Location</label>
                <input type="text" class="form-control" name="eloc" id="eloc" >
              </div>
              <div class="form-group">
                <label for="exampleFormControlInput1">Date</label>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
              <button name="editrain" class="btn btn-success">Edit Training Record</button>
            </div>
          </div>
        </div>
      </form>
