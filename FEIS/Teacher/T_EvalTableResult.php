...
<body>
		...
		<ul class="nav-links">
			...
			<li class="sub">
				<a href="T_EvalHistory.php">
					<i class="fas fa-poll-h" class="active"></i>
	...
	<!-- Top Bar -->
	<section class="home-section" style="min-height: 129vh;">
		<nav>
					...
					<div class="cards">
						...
						<div class="rows2">
							<div class="card-header" style="background-color: #343F66; color: white; padding:10px;">
								<div class="row">
									<div class="col-sm-4">
										<?php include 'Eval_Assets2/Evaluation.php'; ?>
									</div>
									<div class="col-sm-8" style="text-align:right;">
										<a href="T_EvalHistory.php" class="btn btn-success" >Back</a>
									</div>
								</div>
							</div>
							<div class="columns2">
								...
								<div class="cards2" style="padding:0px;">
									...
									<div class="rows3">
										<div class="columns3">
											<div class="cards3">
												<?php include 'Eval_Assets2/Eval.php'; ?>
											</div>

											<div class="cards3">
												<?php include 'Eval_Assets2/Eval2.php'; ?>
											</div>
	...
	<script src="Eval_Assets2/js/Result.js?v=<?php echo time(); ?>">	</script>


	<?php include 'Eval_Assets2/show_all.php'; ?>
