...
<br><br>
    ...
    <center>
      <div class="container" style="background-color: #343F66; color: white; padding: 15px;">
        <div class="row">
      ...
      <div class="container">
        ...
        <form method="post">
          <table id="example" class="table  table-bordered nowrap" style="width:100%">
            ...
            <tbody >
              <?php include 'Records/registration.php'; ?>
            </tbody>
          </table>
        </form>
      ...
      <div class="modal fade" id="confirm" role="dialog" style="text-align:left;">
        <form method="post">
          <?php include 'Records/add_reg.php'; ?>
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button name="confirm" class="btn btn-success">Add Account</button>
            </div>
          </div>
        </div>
      </form>
      ...
      <div class="modal fade" id="del" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="text-align:left;">
        <form method="post">
          <?php include 'Records/del_reg.php'; ?>
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header" style="background-color: #343F66; color: white;">
                Delete Registration
              ...
              <div class="modal-body" id="body">
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">ID</label>
                  <input type="text" class="form-control" name="drid" id="drid" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">First Name</label>
                  <input type="text" class="form-control" name="dfname" id="dfname" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Last Name</label>
                  <input type="text" class="form-control" name="dlname" id="dlname" disabled>
                </div>

              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                <button class="btn btn-success" name="delreg" id="delreg">Delete Registration </button>
              </div>
            </div>
          </div>
