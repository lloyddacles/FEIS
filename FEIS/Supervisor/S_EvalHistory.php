...
<body>
  ...
  <section class="home-section" style="min-height: 120vh;">
    ...
    <center>
      <div class="container" style="background-color: #343F66; color: white; padding: 16px;">
        <div class="row">
          ...
          <div class="col-sm-8"style="text-align:right;">
            <a href="S_EvalSchedule.php" class="btn btn-success">Evaluation Schedule</a>
          </div>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-success" name="delhis" id="delhis">Delete History</button>
              </div>
            </div>
          </div>
      ...
      <div class="modal fade" id="send" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="text-align:left;">
        <form method="post">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header" style="background-color: #343F66; color: white;">
              ...
              <div class="modal-body" id="body">
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">ID</label>
                  <input type="text" class="form-control" name="sevalid" id="sevalid" readonly>
                </div>
                <div class="form-group">
                  <label for="formGroupExampleInput1" style="padding-left: 10px;">Teacher</label>
                  <select class="form-control" name="steacher" id="steacher" disabled>
                    <option value="" disabled selected>Select Teacher</option>
                    <?php include 'Eval_Assets/select_tc.php'; ?>
                  </select>
                  <select class="form-control" name="sid" id="sid"  style="display:none; overflow:hidden;">
                    <option value="" disabled selected>Select Teacher</option>
                    <?php include 'Eval_Assets/select_tc.php'; ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">Percent</label>
                  <input type="text" class="form-control" name="spercent" id="spercent" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Date</label>
                  <input type="datetime" class="form-control" name="sdat" id="sdat" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Status</label>
                  <input type="text" class="form-control" name="sstats" id="sstats" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Acknowledgement</label>
                  <input type="text" class="form-control" name="sack" id="sack" disabled>
                </div>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                <button class="btn btn-success" name="send" id="send">Send Evaluation</button>
              </div>
            </div>
          </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" id="body">
                ...
                <div class="form-group">
                  <label for="formGroupExampleInput1" style="padding-left: 10px;">Teacher</label>
                  <select class="form-control" name="uteacher" id="uteacher" disabled >
                    <option value="" disabled selected>Select Teacher</option>
                    <?php include 'Eval_Assets/select_tc.php'; ?>
                  </select>
                </div>
