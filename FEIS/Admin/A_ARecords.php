...
<body>
  ...
  <section class="home-section" style="min-height: 120vh;">
    ...
    <center>
      <div class="container" style="background-color: #343F66; color: white; padding: 16px;">
        <div class="row">
          ...
          <div class="col-sm-8" style="text-align:right;">
            <button type="button" class="btn btn-success" id="add_account">Add Account Records</button>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <table id="example" class="table  table-bordered nowrap" style="width:100%">
          ...
          <tbody >
            <?php include 'Records/account.php'; ?>
          </tbody>
        </table>

      </div>
      <div class="modal fade" id="account" role="dialog" style="text-align:left;">
        <form method="post">
          <?php include 'Records/add_acc.php'; ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="subtype">Gender</label>
            ...
            <div class="modal-footer">
              ...
              <button name="addacc" class="btn btn-success">Add Account</button>
            </div>
          </div>
        </div>
      </form>
    ...
    <div class="modal fade" id="dacc" role="dialog" style="text-align:left;">
      <form method="post">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #343F66; color: white;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="did" id="did" readonly>
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">First Name</label>
                  <input type="text" class="form-control" name="dfname" id="dfname" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Last Name</label>
                  <input type="text" class="form-control" name="dlname" id="dlname" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Username</label>
                  <input type="text" class="form-control" name="duname" id="duname" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Password</label>
                  <input type="text" class="form-control" name="dpword" id="dpword" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Email</label>
                  <input type="text" class="form-control" name="demail" id="demail" readonly>
                </div>
                <div class="form-group">
                  <label for="subtype">Account Type</label>
                  <select class="form-control" name="datype" id="datype" disabled>
                    <option>Admin</option>
                    <option>Supervisor</option>
                    <option>Teacher</option>
                  </select>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
            <button name="dacc" class="btn btn-success">Delete Account</button>
          </div>
        </div>
      </div>
    </form>
    ...
    <div class="modal fade" id="eacc" role="dialog" style="text-align:left;">
      <form method="post">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #343F66; color: white;">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="eid" id="eid" readonly>
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">First Name</label>
                  <input type="text" class="form-control" name="efname" id="efname" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Last Name</label>
                  <input type="text" class="form-control" name="elname" id="elname" readonly>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Username</label>
                ...
                <div class="form-group">
                  <label for="exampleFormControlInput1">Password</label>
                  <input type="text" class="form-control" name="epword" id="epword">
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Email</label>
                ...
                <div class="form-group">
                  <label for="subtype">Account Type</label>
                  <select class="form-control" name="eatype" id="eatype">
                    <option>Admin</option>
                    <option>Supervisor</option>
                    <option>Teacher</option>
                  </select>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
            <button name="eacc" class="btn btn-success">Edit Account</button>
          </div>
        </div>
      </div>
    </form>
