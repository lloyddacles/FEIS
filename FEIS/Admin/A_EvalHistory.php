      ...
      <div class="container" style="background-color: #343F66; color: white; padding: 16px;">
        <div class="row">
          ...
          <div class="col-sm-8"style="text-align:right;">
            <a href="A_EvalSchedule.php" class="btn btn-success">Evaluation Schedule</a>
          </div>
        </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" id="body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="dat" id="dat" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Status</label>
                  <input type="Date" class="form-control" name="stats" id="stats" disabled>
                </div>
                <div class="form-group">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" id="body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="steacher" id="steacher" disabled>
                </div>
                <div class="form-group">
                  <label for="exampleFormControlInput1">Total Score</label>
