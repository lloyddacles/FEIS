                  ...
                  <div class="card action_bar">
                    <div class="body">
                      <div class="row clearfix">
                        <div class="col-lg-5 col-md-4 col-6">
                          <div class="input-group search">
                            <form method="post">
                            <input type="text" class="form-control" placeholder="Search..." name="searchemail1">
                            </form>
                      ...
                      <div class="col-sm-auto text-right">
                        <form method="post">
                          <button name="markallasread3" class="btn btn-primary" title="Mark All as Read"><i class='bx bx-check-square bx-md' ></i></button>
                          <button name="markallasunread3" class="btn btn-primary" title="Mark All as Unread"><i class='bx bx-checkbox-minus bx-md' ></i></button>
