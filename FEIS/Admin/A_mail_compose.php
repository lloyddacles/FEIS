...
<div class="row inbox">
	<div class="col-md-3">
		<div class="panel panel-default">
			<div class="panel-default inbox-menu">
				<a href="A_mail_compose.php" class="btn btn-primary btn-block">New Email</a>
				<ul>
          <li>
            <a href="A_Inbox.php"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary"><?php emailbadgecountA(); ?></span></a>
          </li>
          <li>
            <a href="A_Trash.php"><i class="fa fa-trash-o"></i> Trash<span class="label label-primary"><?php A_trashbadge(); ?></span></a>
          </li>
          <li>
            <a href="A_Important.php"><i class="fa fa-bookmark"></i> Important<span class="label label-primary"><?php A_importantbadge(); ?></span></a>
          </li>
				</ul>
			</div>
		</div>
    <div class="panel panel-default" style="height: 250px; overflow: scroll;">
      <div class="panel-default contacts">
        <a href="A_mail_compose.php" class="btn btn-primary btn-block"> Online Contacts</a>
        <ul>
          <?php  A_Online(); ?>
        </ul>
    ...
    <div class="panel panel-default" style="height: 250px; overflow: scroll;">
      <div class="panel-default contacts">
        <a href="A_mail_compose.php" class="btn btn-primary btn-block"> Offline Contacts</a>
        <ul>
          <?php  A_Offline(); ?>
        </ul>
			...
			<div class="panel-body message">
				...
				<form class="form-horizontal" method="POST" enctype="multipart/form-data">
					<div class="form-group">
				    	...
				    	<div class="col-sm-11">
                              <input type="email" class="form-control select2-offscreen" id="to" placeholder="Type email" tabindex="-1" name="receiverA">
				    	</div>
				  	</div>
            <div class="form-group">
  				    	<label for="to" class="col-sm-1 control-label">Subject:</label>
  				    	<div class="col-sm-11">
                                <input type="text" class="form-control select2-offscreen" id="to" placeholder="Type subject" tabindex="-1" name="subjectA">
  				    	</div>
  				  	</div>
					<div class="form-group">
				    	<label for="cc" class="col-sm-1 control-label">CC:</label>
				    	<div class="col-sm-11">
                              <input type="email" class="form-control select2-offscreen" id="cc" placeholder="Type email" tabindex="-1" name="emailA2">
				    	</div>
				  	</div>
					<div class="form-group">
				    	<label for="bcc" class="col-sm-1 control-label">BCC:</label>
				    	<div class="col-sm-11">
                              <input type="email" class="form-control select2-offscreen" id="bcc" placeholder="Type email" tabindex="-1" name="emailA3">
				    	</div>
				  	</div>
				...
				<div class="col-sm-11 col-sm-offset-1">
					...
					<div class="form-group">
						...
						<textarea class="wysihtml5 form-control" id="message" rows="12" placeholder="Click here to compose a message.."  name="messageA" required></textarea>
...
<?php include "php/A_mail_compose_func.php"; ?>
