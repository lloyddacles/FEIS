...
$(document).ready(function(){
  $(document).on('click','a[data-role=delacc]',function(){
    var id = $(this).data('id');
    var fn = $('#'+id).children('td[data-target=fname]').text();
    var ln = $('#'+id).children('td[data-target=lname]').text();
    var un = $('#'+id).children('td[data-target=uname]').text();
    var pw = $('#'+id).children('td[data-target=pword]').text();
    var em = $('#'+id).children('td[data-target=email]').text();
    var ty = $('#'+id).children('td[data-target=typ]').text();
    $('#did').val(id);
    $('#dfname').val(fn);
    $('#dlname').val(ln);
    $('#duname').val(un);
  ...
  $(document).on('click','a[data-role=editacc]',function(){
    var id = $(this).data('id');
    var fn = $('#'+id).children('td[data-target=fname]').text();
    var ln = $('#'+id).children('td[data-target=lname]').text();
    var un = $('#'+id).children('td[data-target=uname]').text();
