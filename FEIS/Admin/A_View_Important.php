          ...
          <section class="content inbox">
            <div class="container-fluid">
              <div class="row clearfix">
                <div class="col-lg-12">
                  <div class="card action_bar" style="background-color: #343F66; color: white; padding: 10px; ">
                    <div class="body">
                      <div class="row clearfix">
                ...
                <div class="col-md-12 col-lg-12 col-xl-12" >
                  <div class="card" style="background-color: white; height: 607px; overflow: scroll;">
                    <div class="body">
                      ...
                      <br>
                      <a href="A_Important.php" class="btn btn-primary" style="float:left;">Go back to inbox</a>
                    </div>
                  </div>
                </div>
              </div>
