          ...
          <div class="panel panel-default">
            <div class="panel-default inbox-menu">
              ...
              <ul>
                ...
                <li>
                  <a href="A_Trash.php"><i class="fas fa-trash"></i> Trash<span class="label label-primary"><?php A_trashbadge(); ?></span></a>
                </li>
                <li>
                ...
                <div class="col-lg-12">
                  <div class="card action_bar">
                        ...
                        <div class="col-lg-5 col-md-4 col-6">
                          <div class="input-group search">
                            <form  method="post">
                              ...
                              <input type="text" class="form-control" placeholder="Search..." name="searchemail2">
                    ...
                    <div class="col-sm-auto text-right">
                      <form method="post">
                        <button name="markallasread2" class="btn btn-primary" title="Mark All as Read"><i class='bx bx-check-square bx-md' ></i></button>
                        <button name="markallasunread2" class="btn btn-primary" title="Mark All as Unread"><i class='bx bx-checkbox-minus bx-md' ></i></button>
                        <button type="refresh" name="refresh" class="btn btn-primary"><i class='bx bx-refresh bx-md'></i></button>
                      </form>
                    </div>
